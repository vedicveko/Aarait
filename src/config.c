...
int pk_allowed(struct char_data *ch, struct char_data *vict) { 
  ...
  if(IS_NPC_HIGHHUMAN(vict) || IS_NPC_PIG(vict) || IS_NPC_SKELETON(vict) || IS_NPC_CRAB(vict) || !IS_NPC(vict)) {
   return FALSE;
  }
...
room_vnum mortal_start_room = 484;
 ...
 * donation rooms.
 */
room_vnum donation_room_1 = 1204;
...
"\r\n"
"Welcome to Aarait!  May your days be profitable."
"\r\n\r\n";

const char *START_MESSG =
"Welcome.  This is your new Aarait character! Please type  HELP FISH, or HELP PIG for instructions.\r\n";
