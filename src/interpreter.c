...
cpp_extern const struct command_info cmd_info[] = {
    ...
    {"apply", POS_STANDING, do_not_here, 0, 0},
    ...
    {"bigmap", POS_RESTING, do_bigmap, 0, 0},

    {"castout", POS_SITTING, do_cast, 1, 0},
    {"cackle", POS_RESTING, do_action, 0, 0},
    {"check", POS_STANDING, do_not_here, 1, 0},
    {"chum", POS_STANDING, do_chum, 0, 0},
    ...
    {"copyto", POS_DEAD, do_copyto, 0, LVL_IMMORT},
    {"compare", POS_RESTING, do_compare, 0, 0},
    {"complete", POS_STANDING, do_not_here, 0, 0 },
    ...
    {"request", POS_STANDING, do_not_here, 0, 0},
    {"finished", POS_STANDING, do_not_here, 0, 0},
    {"force", POS_SLEEPING, do_force, LVL_GOD, 0},
    {"fart", POS_RESTING, do_action, 0, 0},
    {"feed", POS_STANDING, do_feed, 0, 0},
    {"fill", POS_STANDING, do_pour, 0, SCMD_FILL},
    {"file", POS_DEAD, do_file, 31, 0},
    {"fish", POS_DEAD, do_fish, 0, 0},
    ...
    {"has", POS_RESTING, do_has, 0, 0},
    {"help", POS_DEAD, do_help, 0, 0},
    {"htell", POS_RESTING, do_htell, 0, 0},
    ...
    {"light", POS_RESTING, do_not_here, 0, 0 },
    ...
    {"omni", POS_DEAD, do_omni, LVL_GOD, 0},
    ...
    {"players", POS_DEAD, do_players, LVL_GOD, 0},
    {"peace", POS_DEAD, do_peace, LVL_GOD, 0},

    {"qecho", POS_DEAD, do_qcomm, LVL_IMMORT, SCMD_QECHO},
    {"qstat", POS_DEAD, do_qstat, LVL_IMMORT, 0},
//    {"qedit", POS_DEAD, do_oasis, LVL_BUILDER, SCMD_OASIS_QEDIT},
    {"qlist", POS_DEAD, do_qlist, LVL_IMMORT, 0},
    {"autoloot", POS_DEAD, do_gen_tog, 0, SCMD_AUTOLOOT},
    {"autobait", POS_DEAD, do_gen_tog, 0, SCMD_AUTOBAIT},
    {"tips", POS_DEAD, do_gen_tog, 0, SCMD_TIPS},
   ...
   {"reply", POS_SLEEPING, do_reply, 0, 0},
    ...
    {"records", POS_DEAD, do_records, 0, 0},
    ...
    {"gohome", POS_STANDING, do_recall, 0, 0},
    {"home", POS_STANDING, do_recall, 0, 0},
...
//    {"shoot", POS_FIGHTING, do_shoot, 0, 0},
    ...
    {"souwee", POS_STANDING, do_souwee, 0, 0},
    {"skillst", POS_DEAD, do_skills, 0, 0},
    ...
    {"stable", POS_STANDING, do_not_here, 0, 0},
...
//    {"throw", POS_FIGHTING, do_throw, 0, 0},
    ...
    {"unbait", POS_SITTING, do_unbait, 0, 0}, 
    ...
    {"assedit", POS_STANDING, do_assedit, LVL_IMPL, 0},
...
ACMD(do_alias)
{
	...
	if (!*repl) {
		...
		|| strchr(repl, ALIAS_VAR_CHAR)) a->type = ALIAS_COMPLEX;
	    else
		a->type = ALIAS_SIMPLE;
...
int perform_dupe_check(struct descriptor_data *d)
{
	...
	act
	    ("$n suddenly keels over in pain, surrounded by a white aura...\r\n"
	     "$n's body has been taken over by a new spirit!", TRUE,
...
void nanny(struct descriptor_data *d, char *arg)
{
	...
	*(GET_PASSWD(d->character) + MAX_PWD_LENGTH) = '\0';
	...
	SEND_TO_Q("Do you want to enable ANSI color (y//n)? ", d);
	STATE(d) = CON_QCOLOR;
	break;
	...
	case 'N':
	    ...
	    STATE(d) = CON_QCLASS;
	    SEND_TO_Q("\r\nSelect an occupation: ", d);
	    return;
	    break;
	default:
	    SEND_TO_Q("Pick Y or N.  Color? ", d);
	    return;
	    break;
	}
	...
	case '1':
		...
		sprintf(buf, "/cG%s has entered the game./c0\r\n",
			GET_NAME(d->character));
		send_to_all(buf);
	    }
	    STATE(d) = CON_PLAYING;
