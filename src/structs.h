...
#define ROOM_VIEW_DESC         (1 << 16)
#define ROOM_SALT_FISH            (1 << 17)
#define ROOM_NOVIEW             (1 << 18)
#define ROOM_FERRY              (1 << 19) // Ferry has arrived.
...
#define SECT_BRIDGE                  13
#define SECT_BLANK                   14
#define SECT_RUINS                   15
#define SECT_JUNGLE                  16
#define SECT_SWAMP                   17
#define SECT_LAVA                    18 
#define SECT_FARM                    19
#define SECT_ACORN                   20
#define SECT_EMPTY                   21
...
#define CLASS_GOBLIN_SLAYER 0
#define CLASS_FISHERMAN     1
#define CLASS_PIG_FARMER    2 
#define CLASS_JOBLESS       3 // The Bum!
...
#define RACE_NPC_CHICKEN     1 
#define RACE_NPC_AVIAN       2
#define RACE_NPC_MAMMAL      3
#define RACE_NPC_SHEEP       4
#define RACE_NPC_GOAT        5
#define RACE_NPC_INSECT      6
#define RACE_NPC_HIGHHUMAN   7 
#define RACE_NPC_SKELETON    8 
#define RACE_NPC_COW         9
#define RACE_NPC_GOBLIN     10
#define RACE_NPC_PIG        11
#define RACE_NPC_WOLF       12
#define RACE_NPC_CRAB       13
#define RACE_NPC_FISH       14
#define NUM_NPC_RACE        15  // Always one more!

#define MAX_ITEMS_TO_EAT    11

#define CLASS_NPC_OTHER             0
#define CLASS_NPC_FARMER            1
#define CLASS_NPC_FISHERMAN         2
#define CLASS_NPC_PIG_FARMER        3
#define CLASS_NPC_CLERGY            4
#define CLASS_NPC_GUARD             5
#define CLASS_NPC_MILLER            6
#define CLASS_NPC_THIEF             7
#define CLASS_NPC_MERCHANT          8
#define NUM_NPC_CLASS               9

// NPC SIZES
#define SIZE_FINE		8
#define SIZE_DIMINUTIVE		4
#define SIZE_TINY		2
#define SIZE_SMALL		1
#define SIZE_MEDIUM		0
#define SIZE_LARGE		-1	
#define SIZE_HUGE		-2
#define SIZE_GARGANTUAN		-4
#define SIZE_COLOSSAL		-8

/* Noble Houses */
#define HOUSE_UNDEFINED         -1
#define HOUSE_DE_TOURNEVILLE	0
#define HOUSE_VEKO		1
#define HOUSE_ESINON            2
#define HOUSE_FENIX             3
#define HOUSE_KENSINGTON        4
#define HOUSE_BENNYSON          5
#define NUM_HOUSES              6


#define RANK_CITIZEN   1
#define RANK_LORD      2
#define RANK_BARON     3
#define RANK_VISCOUNT  4
#define RANK_COUNT     5
#define RANK_EARL      6
#define RANK_MARQUEE   7
#define RANK_DUKE      8
#define RANK_PRINCE    9
#define RANK_EMPEROR   10
#define MAX_RANK       10
...
#define PLR_PIG_DONE    (1 << 16)  // Has completed the pig farmer job  */
#define PLR_GOB_DONE    (1 << 17)  // Has completed the goblin slayer job
#define PLR_FISH_DONE   (1 << 18)  // Has Completed the fisherman job
...
#define MOB_HERD         (1 << 13) /* Mobs like to travel in herds      */
#define MOB_RUN_AWAY     (1 << 14) /* Mob will run from fights in a room */
#define MOB_SLEEPS       (1 << 15)
#define MOB_HIBERNATE    (1 << 16)
#define MOB_NOEMOTE      (1 << 17)
#define MOB_SMALL        (1 << 18)
#define MOB_MEDIUM       (1 << 19)
#define MOB_LARGE        (1 << 20)
#define MOB_NOCTURNAL    (1 << 21)
#define MOB_JOBMASTER    (1 << 22)
#define MOB_STAY_CITY    (1 << 23)
#define MOB_ACORN_EAT    (1 << 24)
#define MOB_LEADER       (1 << 25) // Mob is a HERD leader
#define MOB_STAY_SECT    (1 << 26)
#define MOB_HUNTER       (1 << 27)
...
#define PRF_TIPS        (1 << 24)
#define PRF_DEBUG       (1 << 25) 
#define PRF_AUTOBAIT    (1 << 26)
...
#define AFF_FISHING           (1 << 22)    // Character is fishing
...
#define CON_QCOLOR       24
#define CON_ASSEDIT      25
#define CON_QEDIT        26
...
#define ITEM_FISH      24               // Item is a fishermans fish
#define ITEM_POLE      25               // Item is a fishermans pole
#define ITEM_BAIT      26		// Fish Bait
...
#define ITEM_WEAR_OFFHAND       (1 << 15)

/* Extra object flags: used by obj_data.obj_flags.extra_flags */
#define ITEM_BODY_PART         (1 << 0)	/* Item is glowing		*/
#define ITEM_THROW           (1 << 1)	/* Item is throwable		*/
...
#define ITEM_ANTI_PIG_FARMER (1 << 12)	/* Not usable by mages		*/
#define ITEM_ANTI_GOBLIN_SLAYER (1 << 13)
#define ITEM_ANTI_FISHERMAN (1 << 14)
#define ITEM_UNUSED        (1 << 15)
#define ITEM_NOSELL	   (1 << 16)	/* Shopkeepers won't touch it	*/
#define ITEM_BOW           (1 << 17)
#define ITEM_CROSSBOW      (1 << 18)  
#define ITEM_TWO_HANDED    (1 << 19)
#define ITEM_DECAYS        (1 << 20)   // Item will decay over time
...
typedef sh_int	job_vnum;
typedef sh_int	job_rnum;
...
struct room_data {
   ...
   byte chum;                   // Ammount of chum in the room.
   int orig_sector;             // Second sector
   int timer;                   // How long until we restore the original
};
/* ====================================================================== */

// Stuff for the records system.

struct record_data {
  int type;                          // The record type.
  char name[MAX_NAME_LENGTH + 1];    // Record holders name.
  int value_one;                     
  int value_two;                      
  int value_three;                   
};

#define RECORD_INVALID      0

#define RECORD_ALL_FISH     1  // Heaviest fish of each type
#define RECORD_FISH_TYPE    2  // Most fish of type
#define RECORD_FISH_TOTAL   3  // Total number caught
#define RECORD_FISH_POUNDS  4  // Total number in pounds

#define RECORD_PIG_POUNDS   5  // Total number of pounds raised
#define RECORD_PIG_TOTAL_N  6  // Number of pigs raised
#define RECORD_PIG_HEAVIEST 7  // Heaviest pig raised

#define RECORD_GOBLIN_GNUM  8 // Number of goblins slayed
#define RECORD_GOBLIN_ONUM  9 // Number of Orcs slayed

#define RECORD_MISC_WEALTHIEST  10 // Most money
...
struct char_special_data {
   ...
   byte reel_in;		// How much slack needs to be reeled in.
   int fish_on;			// vnum of fish on line.
   struct char_data *warned;    // Player has been warned about attacking.
   bool weapwarned;             // PLayer has been warned about their weap. 
   int completed;               // Is the current quest complete?
   struct obj_data *job_object; // Pointer to a job_object (Fish)
...
struct player_special_data_saved {
   ...
   int types_of_fish[MAX_FISH+1][2];
   int pigs_raised;
   int goblins_slayed;
   /* spares below for future expansion.  You can change the names from
      'sparen' to something meaningful, but don't change the order.  */
   int jsapre;           // Time in Minutes spent on current job.
   int noble_house;            // Holder for Noble House
   int spells_to_learn;
   int spareint1;
   ubyte color_level;
   ubyte spare1;
...
struct mob_special_data {
   ...
   int mob_hunger;          /* How hungry is the mob? */
   int body_weight;         /* How much the mob wieghs in pounds.      */
   int skill_wait;   
   bool newitem;  
   bool newitemarmor;
   byte fsm_state; 
   byte size;		// D&D size.   
   struct char_data *looking_for; 
};
...
struct char_file_u {
   ...
   sh_int  *completed_quests;
   int  num_completed_quests;
   int  current_quest;
};
/* ====================================================================== */
