...
#define TRADE_NOPIG_FARMER	(1 << 3)
#define TRADE_NOGOBLIN_SLAYER   (1 << 4)
#define TRADE_NOFISHERMAN       (1 << 5)
...
#define NOTRADE_PIG_FARMER(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOPIG_FARMER))
#define NOTRADE_FISHERMAN(i)    (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOFISHERMAN))
#define NOTRADE_GOBLIN_SLAYER(i) (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOGOBLIN_SLAYER))
